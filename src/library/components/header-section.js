class ComponentsHeaderSection extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
...
customElements.define("components-header-section", ComponentsHeaderSection);
