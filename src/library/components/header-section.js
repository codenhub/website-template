        ...
        <div class="sect-container items-baseline">
          ...
          <div class="flex gap-4 items-center flex-wrap w-full">
            ...
            >
              ...
              <span class="px-2 py-1 bg-foreground rounded-full text-sm">0</span>
            </a>
            <a
            ...
            >
              ...
              <span class="px-2 py-1 bg-foreground rounded-full text-sm">4</span>
            </a>
            <a
            ...
            >
              ...
              <span class="px-2 py-1 bg-foreground rounded-full text-sm">2</span>
            </a>
          </div>
        </div>
      </section>
