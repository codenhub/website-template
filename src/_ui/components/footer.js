...
class Footer extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <footer class="sect bg-primary text-contrast">
        <div class="sect-container flex-col gap-8">
          ...
          <div class="flex w-full flex-wrap gap-4 items-center justify-between pt-4 border-t border-neutral-50">
            ...
            <div class="flex gap-4 items-center">
              <!-- GITHUB LINK -->
              <a href="https://github.com/codenhub/" target="_blank" class="size-6">
                <svg viewBox="0 0 20 20" fill="currentColor">
                  <path transform="translate(-84.000000, -7399.000000)"
              ...
              <!-- INSTAGRAM LINK -->
              <a href="https://instagram.com/coden.agency" target="_blank" class="size-6">
              ...
              <!-- X LINK -->
              <a href="https://x.com/codenagency" target="_blank" class="size-6">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path
